...
gulp.task('fontgen', function() {
  return gulp.src("./src/font/**/*.{ttf,otf}")
    .pipe(fontgen({
			css_fontpath: "/static/font/",
      dest: "./static_src/font_build/",
			collate: true
    }));
});
...
gulp.task('prod_font', function() {
  return gulp.src('./src/font_build/**/*')
...
// //AJAX html
// gulp.task('prod_xhrResource', function() {
//   return gulp.src('./frontend/xhr/*.{html,json}')
// 	.on("error", onError)
// 	.pipe(gulp.dest('./static/xhr/'))
// });
